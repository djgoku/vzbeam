defmodule VzBeam.DaemonTest do
  ...
  test "spawns a detached child, redirects stdio to the log, returns a live reparented pid", %{
    dir: dir
  } do
    # spaces in the path exercise quoting
    log = Path.join([dir, "sub dir", "run.log"])
    ...
    # reparented to launchd => survives BEAM exit
    assert String.trim(ppid) == "1"
  end
end
